...
const amenities = [
...

    {
        ...
        featured: true,
        category: "Comfort & Essentials",
        icon: `<svg fill="#4B5563" height="24px" width="24px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.667 490.667" xml:space="preserve" stroke="#4B5563" stroke-width="7.850672"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <g> <path d="M405.909,0H84.757C55.637,0.029,32.035,23.626,32,52.747V405.92c0.035,29.121,23.637,52.717,52.757,52.747h0.576V480 c0,5.891,4.776,10.667,10.667,10.667s10.667-4.776,10.667-10.667v-21.333H384V480c0,5.891,4.776,10.667,10.667,10.667 s10.667-4.776,10.667-10.667v-21.333h0.576c29.121-0.029,52.722-23.626,52.757-52.747V52.747 C458.631,23.626,435.03,0.029,405.909,0z M234.667,437.333H84.757c-17.344-0.018-31.401-14.07-31.424-31.413v-64.587h181.333 V437.333z M234.667,320H53.333V52.747c0.023-17.344,14.08-31.396,31.424-31.413h149.909V320z M437.333,405.92 c-0.023,17.344-14.08,31.396-31.424,31.413h0H256v-96h181.333V405.92z M437.333,320H256V21.333h149.909 c17.344,0.018,31.4,14.07,31.424,31.413V320z"></path> </g> </g> <g> <g> <path d="M160,373.333h-32c-5.891,0-10.667,4.776-10.667,10.667s4.776,10.667,10.667,10.667h32c5.891,0,10.667-4.776,10.667-10.667 S165.891,373.333,160,373.333z"></path> </g> </g> <g> <g> <path d="M362.667,373.333h-32c-5.891,0-10.667,4.776-10.667,10.667s4.776,10.667,10.667,10.667h32 c5.891,0,10.667-4.776,10.667-10.667S368.558,373.333,362.667,373.333z"></path> </g> </g> <g> <g> <path d="M160,128c-5.891,0-10.667,4.776-10.667,10.667v42.667c0,5.891,4.776,10.667,10.667,10.667 c5.891,0,10.667-4.776,10.667-10.667v-42.667C170.667,132.776,165.891,128,160,128z"></path> </g> </g> <g> <g> <path d="M330.667,128c-5.891,0-10.667,4.776-10.667,10.667v42.667c0,5.891,4.776,10.667,10.667,10.667s10.667-4.776,10.667-10.667 v-42.667C341.333,132.776,336.558,128,330.667,128z"></path> </g> </g> </g></svg>`,
    },
...

    {
        ...
        featured: false,
        category: "Home Safety",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bell-electric-icon lucide-bell-electric text-gray-600"><path d="M18.518 17.347A7 7 0 0 1 14 19"/><path d="M18.8 4A11 11 0 0 1 20 9"/><path d="M9 9h.01"/><circle cx="20" cy="16" r="2"/><circle cx="9" cy="9" r="7"/><rect x="4" y="16" width="10" height="6" rx="2"/></svg>
        `
    },
...

    {
        ...
        featured: false,
        category: "Location Features",
        icon: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-waves-ladder-icon lucide-waves-ladder text-gray-600"><path d="M19 5a2 2 0 0 0-2 2v11"/><path d="M2 18c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M7 13h10"/><path d="M7 9h10"/><path d="M9 5a2 2 0 0 0-2 2v11"/></svg>
        `
    },
